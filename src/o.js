$(document).ready(function(){
	...
	var zoom = (function(){
		...
		if( supportsTransforms ) {
			...
			document.body.style.transition = 'transform '+ TRANSITION_DURATION +'ms ease '+ TRANSITION_DELAY;
			document.body.style.OTransition = '-o-transform '+ TRANSITION_DURATION +'ms ease'+ TRANSITION_DELAY;
			document.body.style.msTransition = '-ms-transform '+ TRANSITION_DURATION +'ms ease'+ TRANSITION_DELAY;
			document.body.style.MozTransition = '-moz-transform '+ TRANSITION_DURATION +'ms ease'+ TRANSITION_DELAY;
			document.body.style.WebkitTransition = '-webkit-transform '+ TRANSITION_DURATION +'ms ease'+ TRANSITION_DELAY;
		}
	...
	$('img').click(function(el) {
		...
		zoom.to({element: el.target, pan: false});
	});
